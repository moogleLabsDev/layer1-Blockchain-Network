...
func DefaultConfig() Config {
	return Config{
		...
		LimitedTpsThreshold: ncogearthchain.DefaultEventGas * 120,
		NoTxsThreshold:      ncogearthchain.DefaultEventGas * 30,
		EmergencyThreshold:  ncogearthchain.DefaultEventGas * 5,
